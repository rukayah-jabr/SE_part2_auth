...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public CarDto getCarById(String cardId) {
        Optional<Car> optionalCar = carRepository.findById(cardId);
        return optionalCar.map(Car::getCarDto).orElse(null);
    }

    @Override
    public boolean updateCar(String carId, CarDto carDto) throws IOException {
    ...
    @Override
    public boolean changeBookingStatus(String bookingId, String status) {
